...
1. Builds all IPN challenge images with stable tags.
2. Starts the IPN support stack from `Hack/Box 1/docker-compose.yml`.
...
.generated/systemd/cyber-adventure-ipn.service
```
...
```bash
./labctl.sh generate-service
sudo cp .generated/systemd/cyber-adventure-ipn.service /etc/systemd/system/
sudo systemctl daemon-reload
sudo systemctl enable --now cyber-adventure-ipn.service
```
