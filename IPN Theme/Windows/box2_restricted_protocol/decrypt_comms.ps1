...
if ($MyInvocation.PipelineLength -le 1) {
       Write-Error "Encoded Message: 73, 80, 78.... For security reasons, you must decode the message in one-go. I'm sure you know how to convert ASCII numbers into text with PowerShell... you're paid quite well to know that."
    exit 1
}
